<script>
  import { switcher, authHandlers } from "$lib/store";
  ...
  async function handleAuthentication() {
    ...
    try {
      ...
      addToast({
        data: {
          title: "Error",
          description: `There was a problem while trying to sign in!`,
          color: "text-red-400",
        },
      });
    }
    ...
    <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
      ...
      <div>
        ...
        <div class="mt-6 grid grid-cols-2 gap-4">
          <button
            class="flex w-full items-center justify-center gap-3 rounded-md px-3 py-1.5 border focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1D9BF0]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
          ...
          <a
            href="facebook.com"
            class="flex w-full items-center justify-center gap-3 rounded-md px-3 py-1.5 border focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#24292F]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
